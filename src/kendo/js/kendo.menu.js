        ...
        var Menu = Widget.extend({
                    ...
                    li.data(TIMER, setTimeout(function () {
                        ...
                        if (ul[0] && that._triggerEvent({item: li[0], type: OPEN}) === false) {
                            ...
                            if (!popup) {
                                popup = ul.kendoPopup({
                                    activate: function () {
                                        that._triggerEvent({item: this.wrapper.parent(), type: ACTIVATE});
                                    },
            ...
            _mouseleave: function (e) {
                ...
                if (!that.options.openOnClick && !touch && !((pointers || msPointers) &&
                    e.originalEvent.pointerType in touchPointerTypes) && !contains(e.currentTarget, e.relatedTarget || e.target) && hasChildren && !contains(e.currentTarget, kendo._activeElement())) {
                    that.close(element);
                }
            },
            ...
            _keydown: function (e) {
                ...
                if (key == keys.RIGHT) {
                    ...
                    if (target.length > 0) {
                        that._click({
                            target: target[0], preventDefault: function () {
                            }, enterKey: true
                        });
